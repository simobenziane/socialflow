...
echo ""
echo -e "${YELLOW}To start Cloudflare tunnel (if configured), run in a new terminal:${NC}"
echo "  cloudflared tunnel run socialflow"
echo ""
echo -e "${YELLOW}Or for a quick tunnel (temporary URL):${NC}"
